...
const AppWrapper = ({ children }: { children: React.ReactNode }) => {
  ...
  return (    <div className="mx-auto flex-1 w-full h-full min-h-0 grid grid-cols-1 gap-2 sm:gap-3 lg:gap-4 md:grid-cols-[180px_1fr] lg:grid-cols-[200px_1fr] xl:grid-cols-[240px_1fr] max-w-480 [grid-template-rows:minmax(0,1fr)]">
      {children}
