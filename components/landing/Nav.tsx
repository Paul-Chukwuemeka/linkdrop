...
export default function Nav() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border-subtle/70 bg-background-primary/85 backdrop-blur-md">
      <nav
        aria-label="Main"
        className="mx-auto w-full max-w-300 px-6 md:px-12"
      >
