  ...
  if (mobile) {
    return (
      ...
      >
        ...
        <div
          className={`w-full max-w-94 h-full min-h-200 rounded-xl overflow-hidden  ring-black/10 ${currentFont?.font?.className || ""}`}
        ...
        >
          <div className="rounded-3xl w-full p-6">
            <PublicProfileHeader
              ...
              bio={currentCard?.use_profile_bio !== false ? (profile?.bio || null) : (currentCard?.bio || null)}
      ...
      >
        ...
        >
          <div className="flex flex-col items-center h-fit py-3 sm:py-4 text-center">
            ...
            {(currentCard?.use_profile_bio !== false ? profile?.bio : currentCard?.bio) && (
              <p
