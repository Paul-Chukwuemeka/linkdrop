...
const Fontpicker = () => {
  ...
  return (
    <div className="relative">
      ...
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} label="Select Font">
        <div
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
            {fonts.map((font, i) => {
              ...
              return (
                <button
                  key={i}
                  className={`h-12 sm:h-14 px-4  rounded-lg transition-colors touch-manipulation ${font.font.className} ${
                    isSelected
