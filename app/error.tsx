  ...
  return (
    <div className="flex h-screen w-full flex-col items-center justify-center bg-neutral-50 px-4 text-center">
      <div className="rounded-2xl border bg-white p-8 shadow-(--shadow-card) max-w-md">
        ...
        <button
          onClick={() => reset()}
          className="rounded-full bg-black px-6 py-2.5 text-white shadow-md hover:bg-neutral-800 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green/30"
        >
          Try again
        </button>
      </div>
